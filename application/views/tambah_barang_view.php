										...
										<table class="table table-hover">											
											<tbody>
												...
												<tr>
													...
													<input type="text" class="form-control" id="kode" name="kode" placeholder="Input field"></td>
												</tr>
												<tr>
													<td><label for="">Tanggal Beli</label>
													<input type="date" class="form-control" id="tanggal_beli" name="tanggal_beli" placeholder="Input field"></td>
												</tr>												
												<div class="form-group">
